...
(gtk_accel_path "<Actions>/terminal-window/next-tab" "<Primary>period")
...
(gtk_accel_path "<Actions>/terminal-window/prev-tab" "<Primary>comma")
(gtk_accel_path "<Actions>/terminal-window/move-tab-left" "<Primary><Alt>comma")
; (gtk_accel_path "<Actions>/terminal-window/zoom-in" "<Primary>plus")
; (gtk_accel_path "<Actions>/terminal-window/search-prev" "")
(gtk_accel_path "<Actions>/terminal-window/reset-and-clear" "<Primary>l")
...
(gtk_accel_path "<Actions>/terminal-window/move-tab-right" "<Primary><Alt>period")
...
(gtk_accel_path "<Actions>/terminal-window/reset" "<Shift><Alt>r")
